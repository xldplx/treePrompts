    ...
    return (
        <>
            <section className="h-screen flex flex-col justify-center items-center">
                ...
                <button className="bg-green-500 text-white px-[2rem] py-[1rem] rounded mt-[2rem] hover:scale-105 transition-all duration-300">
                    <h1>browse all prompts</h1>
                </button>
            </section>

            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center">
                <h1 className="text-slate-300">&copy; made by xldplx. 2024.</h1>
            </div>
        </>
    );
}